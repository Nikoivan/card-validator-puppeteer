...
class CardWidget {
  constructor(title, cardCollection) {
...
const card_visa_namespaceObject = __webpack_require__.p + "images/card-visa.gif";
;// CONCATENATED MODULE: ./src/card-widget/img/card-mastercard.gif
const card_mastercard_namespaceObject = __webpack_require__.p + "images/card-mastercard.gif";
;// CONCATENATED MODULE: ./src/card-widget/img/card-amex.gif
const card_amex_namespaceObject = __webpack_require__.p + "images/card-amex.gif";
;// CONCATENATED MODULE: ./src/card-widget/img/card-discover.gif
const card_discover_namespaceObject = __webpack_require__.p + "images/card-discover.gif";
;// CONCATENATED MODULE: ./src/card-widget/img/card-jcb.gif
const card_jcb_namespaceObject = __webpack_require__.p + "images/card-jcb.gif";
;// CONCATENATED MODULE: ./src/card-widget/img/card-diners.gif
const card_diners_namespaceObject = __webpack_require__.p + "images/card-diners.gif";
;// CONCATENATED MODULE: ./src/card-widget/img/mir-logo_norm.png
const mir_logo_norm_namespaceObject = __webpack_require__.p + "images/mir-logo_norm.png";
